...
var LIST_AGENT_VERSIONS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var CREATE_AGENT_VERSION_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/stored/agents/:agentId/versions",
  requiresAuth: true,
  responseType: "json",
...
var GET_AGENT_VERSION_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var ACTIVATE_AGENT_VERSION_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESTORE_AGENT_VERSION_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var DELETE_AGENT_VERSION_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/stored/agents/:agentId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
...
var COMPARE_AGENT_VERSIONS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
//# sourceMappingURL=chunk-WLCV4XHX.cjs.map
//# sourceMappingURL=chunk-WLCV4XHX.cjs.map