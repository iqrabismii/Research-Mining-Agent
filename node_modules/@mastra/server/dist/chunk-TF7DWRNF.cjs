...
var LIST_WORKSPACES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/workspaces",
  responseType: "json",
...
var GET_WORKSPACE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_FS_READ_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_FS_WRITE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_FS_LIST_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_FS_DELETE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
...
var WORKSPACE_FS_MKDIR_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_FS_STAT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SEARCH_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_INDEX_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_LIST_SKILLS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_GET_SKILL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_LIST_SKILL_REFERENCES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_GET_SKILL_REFERENCE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SEARCH_SKILLS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SKILLS_SH_SEARCH_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SKILLS_SH_POPULAR_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SKILLS_SH_PREVIEW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SKILLS_SH_INSTALL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_SKILLS_SH_REMOVE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_SKILLS_SH_UPDATE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
//# sourceMappingURL=chunk-TF7DWRNF.cjs.map
//# sourceMappingURL=chunk-TF7DWRNF.cjs.map