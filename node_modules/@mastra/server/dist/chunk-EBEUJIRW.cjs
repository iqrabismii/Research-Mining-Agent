...
var LIST_STORED_SKILLS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/stored/skills",
  responseType: "json",
...
var GET_STORED_SKILL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var CREATE_STORED_SKILL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/stored/skills",
  responseType: "json",
...
var UPDATE_STORED_SKILL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/stored/skills/:storedSkillId",
  responseType: "json",
  pathParamSchema: storedSkillIdPathParams,
...
var DELETE_STORED_SKILL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/stored/skills/:storedSkillId",
  responseType: "json",
  pathParamSchema: storedSkillIdPathParams,
...
var PUBLISH_STORED_SKILL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
//# sourceMappingURL=chunk-EBEUJIRW.cjs.map
//# sourceMappingURL=chunk-EBEUJIRW.cjs.map