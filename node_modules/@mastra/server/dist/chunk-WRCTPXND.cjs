...
var LIST_WORKFLOWS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/workflows",
  responseType: "json",
...
var GET_WORKFLOW_BY_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_WORKFLOW_RUNS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var GET_WORKFLOW_RUN_BY_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var DELETE_WORKFLOW_RUN_BY_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/workflows/:workflowId/runs/:runId",
  responseType: "json",
  pathParamSchema: workflowRunPathParams,
...
var CREATE_WORKFLOW_RUN_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var STREAM_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESUME_STREAM_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var START_ASYNC_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var START_WORKFLOW_RUN_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var OBSERVE_STREAM_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESUME_ASYNC_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESUME_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESTART_ASYNC_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESTART_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESTART_ALL_ACTIVE_WORKFLOW_RUNS_ASYNC_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var RESTART_ALL_ACTIVE_WORKFLOW_RUNS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var TIME_TRAVEL_ASYNC_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var TIME_TRAVEL_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var TIME_TRAVEL_STREAM_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var CANCEL_WORKFLOW_RUN_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var STREAM_LEGACY_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var OBSERVE_STREAM_LEGACY_WORKFLOW_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
//# sourceMappingURL=chunk-WRCTPXND.cjs.map
//# sourceMappingURL=chunk-WRCTPXND.cjs.map