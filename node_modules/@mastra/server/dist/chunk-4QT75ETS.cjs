...
var GET_MEMORY_STATUS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/memory/status",
  responseType: "json",
...
var GET_MEMORY_CONFIG_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/memory/config",
  responseType: "json",
...
var GET_OBSERVATIONAL_MEMORY_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var AWAIT_BUFFER_STATUS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var LIST_THREADS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/memory/threads",
  responseType: "json",
...
var GET_THREAD_BY_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_MESSAGES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var GET_WORKING_MEMORY_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var SAVE_MESSAGES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var CREATE_THREAD_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/memory/threads",
  responseType: "json",
  queryParamSchema: agentIdQuerySchema,
...
var UPDATE_THREAD_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/memory/threads/:threadId",
  responseType: "json",
  pathParamSchema: threadIdPathParams,
...
var DELETE_THREAD_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/memory/threads/:threadId",
  responseType: "json",
  pathParamSchema: threadIdPathParams,
...
var CLONE_THREAD_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var UPDATE_WORKING_MEMORY_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/memory/threads/:threadId/working-memory",
  responseType: "json",
  pathParamSchema: threadIdPathParams,
...
var DELETE_MESSAGES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var SEARCH_MEMORY_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/memory/search",
  responseType: "json",
...
var GET_MEMORY_STATUS_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_THREADS_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var GET_THREAD_BY_ID_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_MESSAGES_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var SAVE_MESSAGES_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var CREATE_THREAD_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/memory/network/threads",
  responseType: "json",
...
var UPDATE_THREAD_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/memory/network/threads/:threadId",
  responseType: "json",
  pathParamSchema: threadIdPathParams,
...
var DELETE_THREAD_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/memory/network/threads/:threadId",
  responseType: "json",
  pathParamSchema: threadIdPathParams,
...
var DELETE_MESSAGES_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
//# sourceMappingURL=chunk-4QT75ETS.cjs.map
//# sourceMappingURL=chunk-4QT75ETS.cjs.map