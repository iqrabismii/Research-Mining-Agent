...
var LIST_STORED_MCP_CLIENTS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var GET_STORED_MCP_CLIENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var CREATE_STORED_MCP_CLIENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients",
  responseType: "json",
...
var UPDATE_STORED_MCP_CLIENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/stored/mcp-clients/:storedMCPClientId",
  responseType: "json",
  pathParamSchema: storedMCPClientIdPathParams,
...
var DELETE_STORED_MCP_CLIENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/stored/mcp-clients/:storedMCPClientId",
  responseType: "json",
  pathParamSchema: storedMCPClientIdPathParams,
...
//# sourceMappingURL=chunk-KLLES3H6.cjs.map
//# sourceMappingURL=chunk-KLLES3H6.cjs.map