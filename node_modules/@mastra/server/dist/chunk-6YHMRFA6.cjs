...
var LIST_TRACES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/observability/traces",
  responseType: "json",
  queryParamSchema: chunkK52BGIHQ_cjs.wrapSchemaForQueryParams(
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      ...
      const filters = chunkK52BGIHQ_cjs.pickParams(storage.tracesFilterSchema, transformedParams);
      const pagination = chunkK52BGIHQ_cjs.pickParams(storage.paginationArgsSchema, transformedParams);
      const orderBy = chunkK52BGIHQ_cjs.pickParams(storage.tracesOrderBySchema, transformedParams);
...
var GET_TRACE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var SCORE_TRACES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var LIST_SCORES_BY_SPAN_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      const pagination = chunkK52BGIHQ_cjs.pickParams(storage.paginationArgsSchema, params);
      const spanIds = chunkK52BGIHQ_cjs.pickParams(storage.spanIdsSchema, params);
...
//# sourceMappingURL=chunk-6YHMRFA6.cjs.map
//# sourceMappingURL=chunk-6YHMRFA6.cjs.map