...
var LIST_STORED_AGENTS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/stored/agents",
  responseType: "json",
...
var GET_STORED_AGENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var CREATE_STORED_AGENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/stored/agents",
  responseType: "json",
...
var UPDATE_STORED_AGENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/stored/agents/:storedAgentId",
  responseType: "json",
  pathParamSchema: chunkNFT3DDOK_cjs.storedAgentIdPathParams,
...
var DELETE_STORED_AGENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/stored/agents/:storedAgentId",
  responseType: "json",
  pathParamSchema: chunkNFT3DDOK_cjs.storedAgentIdPathParams,
...
var PREVIEW_INSTRUCTIONS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
//# sourceMappingURL=chunk-JOPP6EPR.cjs.map
//# sourceMappingURL=chunk-JOPP6EPR.cjs.map