...
var LIST_STORED_WORKSPACES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var GET_STORED_WORKSPACE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var CREATE_STORED_WORKSPACE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/stored/workspaces",
  responseType: "json",
...
var UPDATE_STORED_WORKSPACE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/stored/workspaces/:storedWorkspaceId",
  responseType: "json",
  pathParamSchema: chunk4Q3QO4MB_cjs.storedWorkspaceIdPathParams,
...
var DELETE_STORED_WORKSPACE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/stored/workspaces/:storedWorkspaceId",
  responseType: "json",
  pathParamSchema: chunk4Q3QO4MB_cjs.storedWorkspaceIdPathParams,
...
//# sourceMappingURL=chunk-HSCXC7K5.cjs.map
//# sourceMappingURL=chunk-HSCXC7K5.cjs.map