...
var LIST_DATASETS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/datasets",
  responseType: "json",
...
var CREATE_DATASET_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/datasets",
  responseType: "json",
...
var GET_DATASET_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var UPDATE_DATASET_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: datasetIdPathParams,
...
var DELETE_DATASET_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: datasetIdPathParams,
...
var LIST_ITEMS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var ADD_ITEM_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/items",
  responseType: "json",
  pathParamSchema: datasetIdPathParams,
...
var GET_ITEM_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var UPDATE_ITEM_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: datasetAndItemIdPathParams,
...
var DELETE_ITEM_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: datasetAndItemIdPathParams,
...
var LIST_EXPERIMENTS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var TRIGGER_EXPERIMENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/experiments",
  responseType: "json",
  pathParamSchema: datasetIdPathParams,
...
var GET_EXPERIMENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_EXPERIMENT_RESULTS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var COMPARE_EXPERIMENTS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var LIST_DATASET_VERSIONS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_ITEM_VERSIONS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var GET_ITEM_VERSION_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var BATCH_INSERT_ITEMS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var BATCH_DELETE_ITEMS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId/items/batch",
  responseType: "json",
  pathParamSchema: datasetIdPathParams,
...
//# sourceMappingURL=chunk-FZLEKDYW.cjs.map
//# sourceMappingURL=chunk-FZLEKDYW.cjs.map