...
var UPSERT_VECTORS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var CREATE_INDEX_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var QUERY_VECTORS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var LIST_INDEXES_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var DESCRIBE_INDEX_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var DELETE_INDEX_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/vector/:vectorName/indexes/:indexName",
  responseType: "json",
  pathParamSchema: vectorIndexPathParams,
...
var LIST_VECTORS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/vectors",
  responseType: "json",
...
var LIST_EMBEDDERS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/embedders",
  responseType: "json",
...
//# sourceMappingURL=chunk-FO3P4UTK.cjs.map
//# sourceMappingURL=chunk-FO3P4UTK.cjs.map