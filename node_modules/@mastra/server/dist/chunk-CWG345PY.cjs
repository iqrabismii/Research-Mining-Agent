...
// src/server/handlers/logs.ts
var LIST_LOG_TRANSPORTS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_LOGS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/logs",
  responseType: "json",
...
var LIST_LOGS_BY_RUN_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/logs/:runId",
  responseType: "json",
...
//# sourceMappingURL=chunk-CWG345PY.cjs.map
//# sourceMappingURL=chunk-CWG345PY.cjs.map