...
var LIST_STORED_SCORERS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/stored/scorers",
  responseType: "json",
...
var GET_STORED_SCORER_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var CREATE_STORED_SCORER_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/stored/scorers",
  responseType: "json",
...
var UPDATE_STORED_SCORER_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "PATCH",
  path: "/stored/scorers/:storedScorerId",
  responseType: "json",
  pathParamSchema: storedScorerIdPathParams,
...
var DELETE_STORED_SCORER_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "DELETE",
  path: "/stored/scorers/:storedScorerId",
  responseType: "json",
  pathParamSchema: storedScorerIdPathParams,
...
//# sourceMappingURL=chunk-FZDRQJ4I.cjs.map
//# sourceMappingURL=chunk-FZDRQJ4I.cjs.map