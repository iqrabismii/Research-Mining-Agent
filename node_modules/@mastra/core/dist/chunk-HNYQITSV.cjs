...
function isToolLoopAgentLike(obj) {
  if (!obj) return false;
  if (obj instanceof chunk76Q75VI4_cjs.ToolLoopAgent) return true;
  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunkPP4G2TZZ_cjs.resolveModelConfig(currentResult.model);
        if (!chunkBCSVBOAN_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunkBCSVBOAN_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-HNYQITSV.cjs.map
//# sourceMappingURL=chunk-HNYQITSV.cjs.map