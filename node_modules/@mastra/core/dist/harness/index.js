import { Mastra } from '../chunk-GTA5BKXZ.js';
import { Agent } from '../chunk-YC6Z75K2.js';
import { Workspace } from '../chunk-ACAILOJE.js';
...
var Harness = class {
  ...
  async getCurrentModelAuthStatus() {
    ...
    try {
      const { PROVIDER_REGISTRY } = await import('../provider-registry-LVP6T63V.js');
