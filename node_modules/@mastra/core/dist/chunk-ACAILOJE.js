import { createTool } from './chunk-CY4ZWL2X.js';
...
function createSkillTool(skills) {
  const tool = createTool({
    ...
    inputSchema: z$1.object({
      name: z$1.string().describe("The name of the skill to activate")
    }),
    execute: async ({ name }) => {
...
function createSkillSearchTool(skills) {
  const tool = createTool({
    ...
    inputSchema: z$1.object({
      ...
      skillNames: z$1.array(z$1.string()).optional().describe("Optional list of skill names to search within"),
      topK: z$1.number().optional().describe("Maximum number of results to return (default: 5)")
    }),
...
function createSkillReadTool(skills) {
  const tool = createTool({
    ...
    inputSchema: z$1.object({
      skillName: z$1.string().describe("The name of the skill"),
      path: z$1.string().describe('Path to the file relative to the skill root (e.g. "references/colors.md", "scripts/run.sh")'),
      startLine: z$1.number().optional().describe("Starting line number (1-indexed). If omitted, starts from the beginning."),
      endLine: z$1.number().optional().describe("Ending line number (1-indexed, inclusive). If omitted, reads to the end.")
    }),
...
//# sourceMappingURL=chunk-ACAILOJE.js.map
//# sourceMappingURL=chunk-ACAILOJE.js.map