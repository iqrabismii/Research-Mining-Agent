...
var chunkZ52OAJ73_cjs = require('./chunk-Z52OAJ73.cjs');
var chunkRXAQEKAJ_cjs = require('./chunk-RXAQEKAJ.cjs');
var chunkCSHG5LWU_cjs = require('./chunk-CSHG5LWU.cjs');
var chunkOWZ6QT24_cjs = require('./chunk-OWZ6QT24.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkOOTLMVNN_cjs.createStreamFromGenerateResult(result)
    };
  }
...
function getStaticProvidersByGateway(name14) {
  return Object.fromEntries(Object.entries(chunkOWZ6QT24_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name14));
}
var defaultGateways = [new chunkRXAQEKAJ_cjs.NetlifyGateway(), new chunkZ52OAJ73_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunkZ52OAJ73_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkZ52OAJ73_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkOOTLMVNN_cjs.AISDKV5LanguageModel(model);
...
async function resolveModelConfig(modelConfig, requestContext = new chunk5WBEMKE2_cjs.RequestContext(), mastra) {
  ...
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof chunkOOTLMVNN_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkOOTLMVNN_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      const registry = chunkOWZ6QT24_cjs.GatewayRegistry.getInstance();
...
//# sourceMappingURL=chunk-PP4G2TZZ.cjs.map
//# sourceMappingURL=chunk-PP4G2TZZ.cjs.map