...
var chunkZ2X5VTYJ_cjs = require('./chunk-Z2X5VTYJ.cjs');
var chunkHNYQITSV_cjs = require('./chunk-HNYQITSV.cjs');
var chunkHAIQ57YB_cjs = require('./chunk-HAIQ57YB.cjs');
var chunkE6I5LBDM_cjs = require('./chunk-E6I5LBDM.cjs');
...
var Mastra = class {
  ...
  get datasets() {
    if (!this.#datasets) {
      this.#datasets = new chunkHAIQ57YB_cjs.DatasetsManager(this);
    }
  ...
  constructor(config) {
    ...
    const workflowEventProcessor = new chunkZ2X5VTYJ_cjs.WorkflowEventProcessor({ mastra: this });
    ...
    if (storage) {
      storage = chunkBCSVBOAN_cjs.augmentWithInit(storage);
    }
    ...
    chunkMR7ZWBL6_cjs.registerHook("onScorerRun" /* ON_SCORER_RUN */, chunkE6I5LBDM_cjs.createOnScorerHook(this));
  ...
  addAgent(agent, key, options) {
    ...
    let mastraAgent;
    if (chunkHNYQITSV_cjs.isToolLoopAgentLike(agent)) {
      mastraAgent = chunkHNYQITSV_cjs.toolLoopAgentToMastraAgent(agent, { fallbackName: key });
    } else {
      mastraAgent = agent;
    }
   ...
   */
  setStorage(storage) {
    this.#storage = chunkBCSVBOAN_cjs.augmentWithInit(storage);
  }
  setLogger({ logger }) {
    this.#logger = logger;
    if (this.#agents) {
  ...
  #syncGatewayRegistry() {
    try {
      ...
      import('./provider-registry-EHOAWHFE.cjs').then(async ({ GatewayRegistry }) => {
...
//# sourceMappingURL=chunk-XJNQHPBJ.cjs.map
//# sourceMappingURL=chunk-XJNQHPBJ.cjs.map