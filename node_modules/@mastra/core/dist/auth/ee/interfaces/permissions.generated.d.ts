 ...
 */
export declare const RESOURCES: readonly ["a2a", "agent-builder", "agents", "logs", "mcp", "memory", "observability", "processors", "scores", "stored-agents", "system", "tools", "vector", "workflows", "workspaces"];
/**
 * Resource type union.
 */
 ...
 */
export declare const PERMISSIONS: readonly ["a2a:read", "a2a:write", "agent-builder:execute", "agent-builder:read", "agent-builder:write", "agents:execute", "agents:read", "agents:write", "logs:read", "mcp:execute", "mcp:read", "mcp:write", "memory:delete", "memory:execute", "memory:read", "memory:write", "observability:read", "observability:write", "processors:execute", "processors:read", "scores:read", "scores:write", "stored-agents:delete", "stored-agents:read", "stored-agents:write", "system:read", "tools:execute", "tools:read", "vector:delete", "vector:execute", "vector:read", "vector:write", "workflows:delete", "workflows:execute", "workflows:read", "workflows:write", "workspaces:delete", "workspaces:read", "workspaces:write"];
/**
