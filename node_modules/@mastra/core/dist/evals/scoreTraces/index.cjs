...
var getTraceStep = chunkZ2X5VTYJ_cjs.createStep({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkHH76UOJL_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkZ2X5VTYJ_cjs.createWorkflow({
