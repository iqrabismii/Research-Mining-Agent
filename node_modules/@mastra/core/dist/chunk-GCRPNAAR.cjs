...
var CoreToolBuilder = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor(input) {
    ...
    if (!chunkM26GEN4C_cjs.isVercelTool(this.originalTool) && (input.autoResumeSuspendedTools || this.originalTool.id?.startsWith("agent-") || this.originalTool.id?.startsWith("workflow-"))) {
  ...
  getParameters = () => {
    if (chunkM26GEN4C_cjs.isVercelTool(this.originalTool)) {
  ...
  createExecute(tool, options, logType, processedSchema) {
    ...
    const execFunction = async (args, execOptions) => {
      ...
      try {
        ...
        if (chunkM26GEN4C_cjs.isVercelTool(tool)) {
          ...
          if (resumeData) {
            const resumeValidation = chunkM26GEN4C_cjs.validateToolInput(resumeSchema, resumeData, options.name);
        ...
        if (suspendData) {
          ...
          const suspendValidation = chunkM26GEN4C_cjs.validateToolSuspendData(suspendSchema, suspendData, options.name);
        ...
        if (chunkM26GEN4C_cjs.isVercelTool(tool)) {
          ...
          const outputValidation = chunkM26GEN4C_cjs.validateToolOutput(outputSchema, result, options.name, false);
    ...
    return async (args, execOptions) => {
      ...
      try {
        ...
        const { data, error: error2 } = chunkM26GEN4C_cjs.validateToolInput(parameters, args, options.name);
  ...
  build() {
    ...
    let needsApprovalFn;
    if (chunkM26GEN4C_cjs.isVercelTool(this.originalTool) && "needsApproval" in this.originalTool) {
...
function ensureToolProperties(tools) {
  const toolsWithProperties = Object.keys(tools).reduce((acc, key) => {
    ...
    if (tool) {
      if (typeof tool === "function" && !(tool instanceof chunkM26GEN4C_cjs.Tool) && !chunkM26GEN4C_cjs.isVercelTool(tool)) {
...
//# sourceMappingURL=chunk-GCRPNAAR.cjs.map
//# sourceMappingURL=chunk-GCRPNAAR.cjs.map