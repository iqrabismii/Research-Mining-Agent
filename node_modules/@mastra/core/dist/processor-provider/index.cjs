...
var unicodeNormalizerProvider = {
  ...
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.UnicodeNormalizer(config);
  }
};
var tokenLimiterProvider = {
  ...
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.TokenLimiterProcessor(
      config
    );
  }
};
var toolCallFilterProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.ToolCallFilter(config);
  }
};
var batchPartsProvider = {
  ...
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.BatchPartsProcessor(config);
  }
};
var moderationProvider = {
  ...
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.ModerationProcessor(config);
  }
};
var promptInjectionDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.PromptInjectionDetector(config);
  }
};
var piiDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.PIIDetector(config);
  }
};
var languageDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.LanguageDetector(config);
  }
};
var systemPromptScrubberProvider = {
  ...
  createProcessor(config) {
    return new chunkBCSVBOAN_cjs.SystemPromptScrubber(config);
  }
};
