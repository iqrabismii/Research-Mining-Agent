...
var NetlifyGateway = class extends chunkCSHG5LWU_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunkCSHG5LWU_cjs.createOpenAI({ apiKey, baseURL, headers }).responses(modelId);
      case "gemini":
      ...
      case "anthropic":
        return chunkCSHG5LWU_cjs.createAnthropic({
          apiKey,
          baseURL: `${baseURL}/v1/`,
          headers: {
...
//# sourceMappingURL=chunk-RXAQEKAJ.cjs.map
//# sourceMappingURL=chunk-RXAQEKAJ.cjs.map